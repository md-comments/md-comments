...
let activeDomParagraphs: HTMLElement[] = [];
...
function getPRHeadBranchFromDom(): string | null {
  ...
  // 3. Fallback to elements
  const headRefEl = document.querySelector('.head-ref, [class*="head-ref"]');
  if (headRefEl) {
...
let sidebarExplicitlyClosed = false;
