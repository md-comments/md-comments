  ...
  activeSidebarHost.innerHTML = `
    <div class="sidebar-header">
      ...
      <div class="sidebar-header-actions">
        ...
        ${isEmbedded ? '' : `<button class="md-comments-header-btn close-btn" type="button" title="Close" aria-label="Close">${ICON_CLOSE}</button>`}
      </div>
...
function showCommentTooltip(targetEl: HTMLElement, commentId: string) {
  ...
  tooltip.innerHTML = `
    <div class="tooltip-header">
      ...
      <span class="tooltip-time" title="${escapeHtml(formatConcreteTime(comment.created_at))}">${formatRelativeTime(comment.created_at)}</span>
    </div>
