import { K as e, U as t, gt as n, m as r, mt as i, q as a } from './internal-DE3OytvW.js';
import {
  Bi as o,
  F as s,
  Gn as c,
  ...
  xe = class {
    ...
    emit(e, t) {
      ...
      if (
        (this.#f &&
          ...
          this.#f.dispatchEvent(
            new CustomEvent(`${this.#t}:${e}`, { detail: this.createEventPayload(e, t) })
          )),
        this.#d)
      ) {
      ...
      if (!this.#a) {
        (this.debugLog(`Bus not available, will be pushed as soon as connected`),
          ...
          typeof CustomEvent < `u` && !this.#u && (this.#h(), this.startConnectLoop()));
        return;
      }
    ...
    on(e, t, n) {
      ...
      if (
        ...
        return (this.debugLog(`Event bus client is disabled, not registering event`, i), () => {});
      let a = (e) => {
...
function we(e) {
  return e.length === 0
    ? null
    : e.every((e) => e.type === `text`)
      ? e.map((e) => e.content).join(``) || null
      : e;
}
function Te(e) {
  return e === null
...
function Ee(e) {
  return e.role === `system` ? [] : e.role === `assistant` ? Ae(e) : [De(e)];
}
function De(e) {
  let t = [];
  for (let n of e.parts) Ce(n) && t.push(n);
  return { role: e.role, content: we(t) };
}
function Oe() {
...
function Ae(e) {
  let t = [],
    ...
    r = new Set();
  function i() {
    let e = we(n.contentParts),
      r = e !== null,
      i = n.toolCalls.length > 0;
    ((r || i) && t.push({ role: `assistant`, content: e, ...(i && { toolCalls: n.toolCalls }) }),
      (n = Oe()));
  }
  for (let a of e.parts)
    switch (a.type) {
      case `text`:
      case `image`:
      case `audio`:
      ...
      case `tool-result`:
        (i(),
          (a.state === `complete` || a.state === `error`) &&
            !r.has(a.toolCallId) &&
            (t.push({ role: `tool`, content: a.content, toolCallId: a.toolCallId }),
            r.add(a.toolCallId)));
    }
  i();
  for (let n of e.parts)
    if (
      ...
      (n.output !== void 0 &&
        !r.has(n.id) &&
        (t.push({ role: `tool`, content: JSON.stringify(n.output), toolCallId: n.id }),
        r.add(n.id)),
      n.output === void 0 &&
        n.state === `approval-responded` &&
        n.approval?.approved !== void 0 &&
        !r.has(n.id))
    ) {
  ...
  return (t.length === 0 && t.push({ role: `assistant`, content: null }), t);
}
function je(e, t) {
  let n = [];
  if (e.role === `tool` && e.toolCallId)
    ...
    let t = Te(e.content);
    t && n.push({ type: `text`, content: t });
  }
  if (e.toolCalls && e.toolCalls.length > 0)
    for (let t of e.toolCalls)
      n.push({
        type: `tool-call`,
        id: t.id,
  ...
  return { id: t || j(), role: e.role === `tool` ? `assistant` : e.role, parts: n };
}
function Me(e, t) {
  return `parts` in e
    ? { ...e, id: e.id || t(), createdAt: e.createdAt || new Date() }
    : { ...je(e, t()), createdAt: new Date() };
}
function j() {
...
function M(e) {
  return {
    ...
    ...e,
    server(t) {
      return { __toolSide: `server`, ...e, execute: t };
    },
    client(t) {
      return { __toolSide: `client`, ...e, execute: t };
    },
  };
}
var Ne = S((e) => {
    (Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (e.INFINITY = 128),
      (e._INFINITY = 256),
      (e.INF = e.INFINITY | e._INFINITY),
      (e.SPECIAL = e.NULL | e.BOOL | e.INF | e.NAN),
      (e.ATOM = e.STR | e.NUM | e.SPECIAL),
      (e.COLLECTION = e.ARR | e.OBJ),
      (e.ALL = e.ATOM | e.COLLECTION),
      (e.Allow = {
        STR: e.STR,
        NUM: e.NUM,
        ARR: e.ARR,
  ...
  Pe = S((e) => {
    ...
    (Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.Allow = e.MalformedJSON = e.PartialJSON = e.parseJSON = e.parse = void 0));
    var r = Ne();
        ...
        l = () => (
          ...
          e[o] === `"`
            ...
            : e[o] === `{`
              ...
              : e[o] === `[`
                ? f()
                : e.substring(o, o + 4) === `null` ||
                    (r.Allow.NULL & t && n - o < 4 && `null`.startsWith(e.substring(o)))
                  ? ((o += 4), null)
                  : e.substring(o, o + 4) === `true` ||
                      (r.Allow.BOOL & t && n - o < 4 && `true`.startsWith(e.substring(o)))
                    ? ((o += 4), !0)
                    : e.substring(o, o + 5) === `false` ||
                        (r.Allow.BOOL & t && n - o < 5 && `false`.startsWith(e.substring(o)))
                      ? ((o += 5), !1)
                      : e.substring(o, o + 8) === `Infinity` ||
                          (r.Allow.INFINITY & t &&
                            n - o < 8 &&
                            `Infinity`.startsWith(e.substring(o)))
                        ? ((o += 8), 1 / 0)
                        : e.substring(o, o + 9) === `-Infinity` ||
                            (r.Allow._INFINITY & t &&
                              1 < n - o &&
                              n - o < 9 &&
                              `-Infinity`.startsWith(e.substring(o)))
                          ? ((o += 9), -1 / 0)
                          : e.substring(o, o + 3) === `NaN` ||
                              (r.Allow.NAN & t && n - o < 3 && `NaN`.startsWith(e.substring(o)))
                            ? ((o += 3), NaN)
                            : p()
        ),
        u = () => {
...
function Ie(e, t, n) {
  return e.map((e) => {
    ...
    return (
      i && i.type === `text`
        ? (r[r.length - 1] = { type: `text`, content: n })
        : r.push({ type: `text`, content: n }),
      { ...e, parts: r }
    );
  });
}
function N(e, t, n) {
  return e.map((e) => {
    if (e.id !== t) return e;
    let r = [...e.parts],
      i = r.find((e) => e.type === `tool-call` && e.id === n.id),
      a = {
        type: `tool-call`,
        id: n.id,
        name: n.name,
    ...
    return (i ? (r[r.indexOf(i)] = a) : r.push(a), { ...e, parts: r });
  });
}
function P(e, t, n, r, i, a) {
  return e.map((e) => {
    if (e.id !== t) return e;
    let o = [...e.parts],
      s = o.findIndex((e) => e.type === `tool-result` && e.toolCallId === n),
      c = { type: `tool-result`, toolCallId: n, content: r, state: i, ...(a && { error: a }) };
    return (s >= 0 ? (o[s] = c) : o.push(c), { ...e, parts: o });
  });
}
function Le(e, t, n, r) {
  return e.map((e) => {
    if (e.id !== t) return e;
    let i = [...e.parts],
      a = i.find((e) => e.type === `tool-call` && e.id === n);
    return (
      a && ((a.state = `approval-requested`), (a.approval = { id: r, needsApproval: !0 })),
      { ...e, parts: i }
    );
  });
}
function F(e, t, n, r, i) {
  return e.map((e) => {
    let a = [...e.parts],
      o = a.find((e) => e.type === `tool-call` && e.id === t);
    return (
      o && ((o.output = i ? { error: i } : n), (o.state = r || `input-complete`)),
      { ...e, parts: a }
    );
  });
}
function Re(e, t, n) {
  return e.map((e) => {
    let r = [...e.parts],
      i = r.find((e) => e.type === `tool-call` && e.approval?.id === t);
    return (
      i && i.approval && ((i.approval.approved = n), (i.state = `approval-responded`)),
      { ...e, parts: r }
    );
  });
}
function ze(e, t, n) {
  return e.map((e) => {
    if (e.id !== t) return e;
    let r = [...e.parts],
      i = r.findIndex((e) => e.type === `thinking`),
      a = { type: `thinking`, content: n };
    return (i >= 0 ? (r[i] = a) : r.push(a), { ...e, parts: r });
  });
}
var Be = class {
    shouldEmit(e, t) {
  ...
  Ve = class e {
    constructor(e = {}) {
      ((this.messages = []),
        ...
        (this.toolCallToMessage = new Map()),
        ...
        (this.chunkStrategy = e.chunkStrategy || new Be()),
        (this.events = e.events || {}),
        (this.jsonParser = e.jsonParser || Fe),
        (this.recordingEnabled = e.recording ?? !1),
        e.initialMessages && (this.messages = [...e.initialMessages]));
    }
    setMessages(e) {
      ((this.messages = [...e]), this.emitMessagesChange());
    }
    addUserMessage(e, t) {
      let n = typeof e == `string` ? [{ type: `text`, content: e }] : e.map((e) => e),
        r = { id: t ?? j(), role: `user`, parts: n, createdAt: new Date() };
    ...
    addToolResult(e, t, n) {
      ...
      let i = F(this.messages, e, t, n ? `input-complete` : void 0, n),
        a = typeof t == `string` ? t : JSON.stringify(t),
        o = n ? `error` : `complete`;
      ((i = P(i, r.id, e, a, o, n)), (this.messages = i), this.emitMessagesChange());
    }
    addToolApprovalResponse(e, t) {
      ((this.messages = Re(this.messages, e, t)), this.emitMessagesChange());
    }
    toModelMessages() {
      let e = [];
      for (let t of this.messages) e.push(...Ee(t));
      return e;
    }
    getMessages() {
    ...
    areAllToolsComplete() {
      ...
      return t.every(
        (e) =>
          e.state === `approval-responded` || (e.output !== void 0 && !e.approval) || n.has(e.id)
      );
    }
    ...
    async process(e) {
      ...
      return (
        this.finalizeStream(),
        this.recording && (this.recording.result = this.getResult()),
        this.getResult()
      );
    }
    processChunk(e) {
    ...
    ensureAssistantMessage(e) {
      if (e) {
        ...
        if (t) return { messageId: e, state: t };
      }
      let t = this.getActiveAssistantMessageId();
      if (t) return { messageId: t, state: this.getMessageState(t) };
      if (e) {
        ...
        if (t) {
          ...
          return (
            r &&
              r.type === `text` &&
              ((n.currentSegmentText = r.content),
              (n.lastEmittedText = r.content),
              (n.totalTextContent = r.content)),
            { messageId: e, state: n }
          );
        }
      }
      let n = e || j(),
        r = { id: n, role: `assistant`, parts: [], createdAt: new Date() };
      this.messages = [...this.messages, r];
      let i = this.createMessageState(n, `assistant`);
      return (
        this.activeMessageIds.add(n),
        (this.pendingManualMessageId = n),
    ...
    handleTextMessageStartEvent(e) {
      let { messageId: t, role: n } = e,
        r = n === `user` || n === `system` ? n : `assistant`;
      if (this.pendingManualMessageId) {
        let e = this.pendingManualMessageId;
        if (((this.pendingManualMessageId = null), e !== t)) {
          this.messages = this.messages.map((n) => (n.id === e ? { ...n, id: t } : n));
          let n = this.messageStates.get(e);
          (n && ((n.id = t), this.messageStates.delete(e), this.messageStates.set(t, n)),
            this.activeMessageIds.delete(e),
            this.activeMessageIds.add(t));
        }
        (this.messageStates.has(t) || (this.createMessageState(t, r), this.activeMessageIds.add(t)),
          this.emitMessagesChange());
        return;
      }
      if (this.messages.find((e) => e.id === t)) {
        if ((this.activeMessageIds.add(t), !this.messageStates.has(t)))
          this.createMessageState(t, r);
        else {
          let e = this.messageStates.get(t);
          e.hasToolCallsSinceTextStart &&=
            (e.currentSegmentText !== e.lastEmittedText && this.emitTextUpdateForMessage(t),
            (e.currentSegmentText = ``),
            (e.lastEmittedText = ``),
            !1);
        }
        return;
      }
      let i = { id: t, role: r, parts: [], createdAt: new Date() };
    ...
    handleTextMessageEndEvent(e) {
      let { messageId: t } = e,
        n = this.getMessageState(t);
      n &&
        (n.isComplete ||
          (n.currentSegmentText !== n.lastEmittedText && this.emitTextUpdateForMessage(t),
    ...
    handleTextMessageContentEvent(e) {
      ...
      n.hasToolCallsSinceTextStart &&
        r.length > 0 &&
        this.isNewTextSegment(e, r) &&
        (r !== n.lastEmittedText && this.emitTextUpdateForMessage(t),
        (n.currentSegmentText = ``),
        (n.lastEmittedText = ``),
        (n.hasToolCallsSinceTextStart = !1));
      let i = n.currentSegmentText,
        a = i,
        o = e.delta || ``;
      o === ``
        ? e.content !== void 0 &&
          e.content !== `` &&
          (a = e.content.startsWith(i) ? e.content : i.startsWith(e.content) ? i : i + e.content)
        : (a = i + o);
      let s = a.slice(i.length);
      ((n.currentSegmentText = a), (n.totalTextContent += s));
      let c = e.delta || e.content || ``;
      this.chunkStrategy.shouldEmit(c, n.currentSegmentText) &&
        n.currentSegmentText !== n.lastEmittedText &&
        this.emitTextUpdateForMessage(t);
    }
    handleToolCallStartEvent(e) {
      let t = e.parentMessageId ?? this.getActiveAssistantMessageId(),
        { messageId: n, state: r } = this.ensureAssistantMessage(t ?? void 0);
      r.hasToolCallsSinceTextStart = !0;
      let i = e.toolCallId;
      if (!r.toolCalls.get(i)) {
        let t = `awaiting-input`,
          a = e.toolCallName,
          o = {
            id: e.toolCallId,
            name: a,
        ...
        (r.toolCalls.set(i, o),
          r.toolCallOrder.push(i),
          this.toolCallToMessage.set(i, n),
          ...
          this.emitMessagesChange(),
          this.events.onToolCallStateChange?.(n, e.toolCallId, t, ``));
      }
    }
    handleToolCallArgsEvent(e) {
      let t = e.toolCallId,
        n = this.toolCallToMessage.get(t);
      if (!n) return;
      ...
      ((i.arguments += e.delta || ``),
        a && e.delta && (i.state = `input-streaming`),
        (i.parsedArguments = this.jsonParser.parse(i.arguments)),
        (this.messages = N(this.messages, n, {
          id: i.id,
          name: i.name,
        ...
        this.emitMessagesChange(),
        this.events.onToolCallStateChange?.(n, i.id, i.state, i.arguments));
    }
    handleToolCallEndEvent(e) {
      ...
      if (e.result) {
        ...
        ((this.messages = F(this.messages, e.toolCallId, n)),
          (this.messages = P(this.messages, t, e.toolCallId, e.result, `complete`)),
          this.emitMessagesChange());
      }
    }
    handleToolCallResultEvent(e) {
      ...
      ((this.messages = F(this.messages, e.toolCallId, n)),
        (this.messages = P(this.messages, t, e.toolCallId, e.content, `complete`)),
        this.emitMessagesChange());
    }
    ...
    handleRunFinishedEvent(e) {
      ((this.finishReason = e.finishReason ?? null),
        this.activeRuns.delete(e.runId),
        this.activeRuns.size === 0 &&
          ((this.isDone = !0), this.completeAllToolCalls(), this.finalizeStream()));
    }
    ...
    handleStepFinishedEvent(e) {
      let { messageId: t, state: n } = this.ensureAssistantMessage(
        this.getActiveAssistantMessageId() ?? void 0
      );
      if (n.hasSeenReasoningEvents) return;
      let r = n.thinkingContent,
        i = r;
      (e.delta && e.delta !== ``
        ? (i = r + e.delta)
        : e.content &&
          e.content !== `` &&
          (i = e.content.startsWith(r) ? e.content : r.startsWith(e.content) ? r : r + e.content),
        (n.thinkingContent = i),
        (this.messages = ze(this.messages, t, n.thinkingContent)),
        this.emitMessagesChange(),
        this.events.onThinkingUpdate?.(t, n.thinkingContent));
    }
    ...
    handleCustomEvent(e) {
      ...
      if (e.name === `tool-input-available` && e.value) {
        ...
        this.events.onToolCall?.({ toolCallId: t, toolName: n, input: r });
        return;
      }
      if (e.name === `approval-requested` && e.value) {
        let { toolCallId: n, toolName: r, input: i, approval: a } = e.value,
          o = t ?? this.toolCallToMessage.get(n);
        (o && ((this.messages = Le(this.messages, o, n, a.id)), this.emitMessagesChange()),
    ...
    isNewTextSegment(e, t) {
      return (
        e.content !== void 0 &&
        (e.content.length < t.length || (!e.content.startsWith(t) && !t.startsWith(e.content)))
      );
    }
    ...
    completeToolCall(e, t, n) {
      ((n.state = `input-complete`),
        (n.parsedArguments = this.jsonParser.parse(n.arguments)),
        (this.messages = N(this.messages, e, {
          id: n.id,
          name: n.name,
          arguments: n.arguments,
          state: `input-complete`,
        ...
        this.emitMessagesChange(),
        this.events.onToolCallStateChange?.(e, n.id, `input-complete`, n.arguments));
    }
    emitTextUpdateForMessage(e) {
      let t = this.getMessageState(e);
      t &&
        ((t.lastEmittedText = t.currentSegmentText),
        (this.messages = Ie(this.messages, e, t.currentSegmentText)),
        this.emitMessagesChange(),
        this.events.onTextUpdate?.(e, t.currentSegmentText));
    }
    emitMessagesChange() {
    ...
    getCompletedToolCalls() {
      let e = [];
      for (let t of this.messageStates.values())
        for (let n of t.toolCalls.values())
          n.state === `input-complete` &&
            e.push({
              id: n.id,
              type: `function`,
    ...
    getResult() {
      let e = this.getCompletedToolCalls(),
        t = ``,
        n = ``;
      for (let e of this.messageStates.values())
        ((t += e.totalTextContent), (n += e.thinkingContent));
      return {
        content: t,
        thinking: n || void 0,
    ...
    startRecording() {
      ((this.recordingEnabled = !0),
        (this.recordingStartTime = Date.now()),
        (this.recording = { version: `1.0`, timestamp: this.recordingStartTime, chunks: [] }));
    }
    getRecording() {
    ...
    isWhitespaceOnlyMessage(e) {
      return (
        e.parts.length !== 0 && e.parts.every((e) => e.type === `text` && e.content.trim() === ``)
      );
    }
    static async replay(t, n) {
      return new e(n).process(He(t));
    }
  };
function He(e) {
  return {
...
var Ue = class {
    ...
    textUpdated(e, t, n) {
      this.emitEvent(`text:chunk:content`, { streamId: e, messageId: t, content: n });
    }
    ...
    thinkingUpdated(e, t, n, r) {
      this.emitEvent(`text:chunk:thinking`, { streamId: e, messageId: t, content: n, delta: r });
    }
    ...
    toolResultAdded(e, t, n, r) {
      this.emitEvent(`tools:result:added`, { toolCallId: e, toolName: t, output: n, state: r });
    }
    toolApprovalResponded(e, t, n) {
      this.emitEvent(`tools:approval:responded`, { approvalId: e, toolCallId: t, approved: n });
    }
  },
  We = class extends Ue {
    emitEvent(e, t) {
      e.startsWith(`client:`) || e.startsWith(`tools:`) || e.startsWith(`text:`)
        ? Se.emit(e, { ...t, clientId: this.clientId, source: `client`, timestamp: Date.now() })
        : Se.emit(e, { ...t, timestamp: Date.now() });
    }
  };
function Ge(e) {
  if (!e) return {};
...
function qe(e) {
  ...
  if (n && r) return { subscribe: e.subscribe.bind(e), send: e.send.bind(e) };
            ...
            ((r =
              t.length > 0
                ...
                : await new Promise((t) => {
                    let r = () => t(null);
                    (n.push((n) => {
                      (e?.removeEventListener(`abort`, r), t(n));
                    }),
    ...
    async send(t, n, r) {
      ...
      try {
        ...
        for await (let e of a)
          ((e.type === `RUN_FINISHED` || e.type === `RUN_ERROR`) && (i = !0), o(e));
        !r?.aborted &&
          !i &&
          o({
            type: `RUN_FINISHED`,
  ...
  return {
    async *connect(n, r, i) {
      let a = typeof e == `function` ? e() : e,
        ...
        s = { 'Content-Type': `application/json`, ...Ge(o.headers) },
        c = { messages: n, data: r, ...o.body },
...
var Ye = class {
  constructor(e) {
    if (
      ...
      (this.continuationSkipped = !1),
      (this.draining = !1),
      (this.sessionGenerating = !1),
      (this.activeRunIds = new Set()),
      (this.uniqueId = e.id || this.generateUniqueId(`chat`)),
      (this.body = e.body || {}),
      (this.connection = qe(e.connection)),
      (this.events = new We(this.uniqueId)),
      ...
      (this.processor = new Ve({
        ...
        events: {
          ...
          onStreamStart: () => {
            ...
            t &&
              ((this.currentMessageId = t.id),
              this.events.messageAppended(t, this.currentStreamId || void 0));
          },
          onStreamEnd: (e) => {
            (this.callbacksRef.current.onFinish(e),
          ...
          onToolCallStateChange: (e, t, n, r) => {
            let i =
              this.processor
                .getMessages()
                .find((t) => t.id === e)
                ?.parts.find((e) => e.type === `tool-call` && e.id === t)?.name || `unknown`;
            this.currentStreamId &&
              this.events.toolCallStateChanged(this.currentStreamId, e, t, i, n, r);
          },
          onToolCall: (e) => {
  ...
  setIsLoading(e) {
    ((this.isLoading = e),
      this.callbacksRef.current.onLoadingChange(e),
      this.events.loadingChanged(e));
  }
  setStatus(e) {
  ...
  setSessionGenerating(e) {
    this.sessionGenerating !== e &&
      ((this.sessionGenerating = e), this.callbacksRef.current.onSessionGeneratingChange(e));
  }
  ...
  setError(e) {
    ((this.error = e),
      this.callbacksRef.current.onErrorChange(e),
      this.events.errorChanged(e?.message || null));
  }
  ...
  startSubscription() {
    ...
    this.consumeSubscription(e)
      ...
      .finally(() => {
        this.subscriptionAbortController?.signal === e &&
          ((this.subscriptionAbortController = null),
          !e.aborted &&
            this.isSubscribed &&
            (this.setIsSubscribed(!1),
            this.connectionStatus !== `error` && this.setConnectionStatus(`disconnected`)));
      });
  }
  async consumeSubscription(e) {
    ...
    for await (let n of t) {
      if (e.aborted) break;
      if (
        (this.connectionStatus === `connecting` && this.setConnectionStatus(`connected`),
        this.callbacksRef.current.onChunk(n),
        this.processor.processChunk(n),
        n.type === `RUN_STARTED` && (this.activeRunIds.add(n.runId), this.setSessionGenerating(!0)),
        n.type === `RUN_FINISHED` || n.type === `RUN_ERROR`)
      ) {
        let e = n.type === `RUN_FINISHED` ? n.runId : void 0;
        (e ? this.activeRunIds.delete(e) : n.type === `RUN_ERROR` && this.activeRunIds.clear(),
  ...
  ensureSubscription() {
    ...
    (!this.subscriptionAbortController || this.subscriptionAbortController.signal.aborted) &&
      this.subscribe({ restart: !0 });
  }
  waitForProcessing() {
    return (
      this.resolveProcessing(),
  ...
  normalizeMessageInput(e) {
    return typeof e == `string` ? { content: e.trim() } : { content: e.content, id: e.id };
  }
  async append(e) {
    let t = Me(e, j);
  ...
  async streamResponse() {
    ...
    try {
      ...
      let r = { ...this.body, ...this.pendingMessageBody, conversationId: this.uniqueId };
      ((this.pendingMessageBody = void 0),
      ...
      if (
        (await this.connection.send(n, r, this.abortController.signal),
        await i,
        e !== this.streamGeneration || this.status === `error`)
      )
        return !1;
      ...
      if (
        ...
        let e = this.processor.getMessages().at(-1)?.parts.at(-1),
          { finishReason: t } = this.processor.getState();
        if (e?.type === `tool-result` && t !== `stop` && this.shouldAutoSend())
          try {
  ...
  subscribe(e) {
    let t = e?.restart === !0;
    (this.isSubscribed && !t) ||
      (this.isSubscribed && t && this.abortSubscriptionLoop(),
      this.setIsSubscribed(!0),
      this.setConnectionStatus(`connecting`),
      this.startSubscription());
  }
  unsubscribe() {
    (this.cancelInFlightStream({ setReadyStatus: !0, abortSubscription: !0 }),
      this.resetSessionGenerating(),
      this.setIsSubscribed(!1),
  ...
  async reload() {
    ...
    t !== -1 &&
      ...
      this.events.reloaded(t),
      this.processor.removeMessagesAfter(t),
      await this.streamResponse());
  }
  stop() {
  ...
  async addToolResult(e) {
    if (
      (this.events.toolResultAdded(e.toolCallId, e.tool, e.output, e.state || `output-available`),
      this.processor.addToolResult(e.toolCallId, e.output, e.errorText),
      this.isLoading)
    ) {
  ...
  async addToolApprovalResponse(e) {
    let t = this.processor.getMessages(),
      n;
    for (let r of t) {
    ...
    if (
      (n && this.events.toolApprovalResponded(e.id, n, e.approved),
      this.processor.addToolApprovalResponse(e.id, e.approved),
      this.isLoading)
    ) {
      this.queuePostStreamAction(() => this.checkForContinuation());
      return;
  ...
  async checkForContinuation() {
    ...
    if (this.shouldAutoSend()) {
      ...
      this.continuationSkipped &&
        e &&
        ((this.continuationSkipped = !1), await this.checkForContinuation());
    }
  }
  shouldAutoSend() {
    let e = this.processor.getMessages().findLast((e) => e.role === `assistant`);
    return !e || !e.parts.some((e) => e.type === `tool-call`)
      ? !1
      : this.processor.areAllToolsComplete();
  }
  getMessages() {
  ...
  updateOptions(e) {
    ...
    (e.onResponse !== void 0 && (this.callbacksRef.current.onResponse = e.onResponse),
      e.onChunk !== void 0 && (this.callbacksRef.current.onChunk = e.onChunk),
      e.onFinish !== void 0 && (this.callbacksRef.current.onFinish = e.onFinish),
      e.onError !== void 0 && (this.callbacksRef.current.onError = e.onError),
      e.onSubscriptionChange !== void 0 &&
        (this.callbacksRef.current.onSubscriptionChange = e.onSubscriptionChange),
      e.onConnectionStatusChange !== void 0 &&
        (this.callbacksRef.current.onConnectionStatusChange = e.onConnectionStatusChange),
      e.onSessionGeneratingChange !== void 0 &&
        (this.callbacksRef.current.onSessionGeneratingChange = e.onSessionGeneratingChange),
      e.onCustomEvent !== void 0 && (this.callbacksRef.current.onCustomEvent = e.onCustomEvent));
  }
};
function Xe(...e) {
  return e;
...
function Ze(e) {
  let t = (0, k.useId)(),
    n = e.id || t,
    [r, i] = (0, k.useState)(e.initialMessages || []),
    [a, o] = (0, k.useState)(!1),
    [s, c] = (0, k.useState)(void 0),
    [l, u] = (0, k.useState)(`ready`),
    [d, f] = (0, k.useState)(!1),
    [p, m] = (0, k.useState)(`disconnected`),
    [h, g] = (0, k.useState)(!1),
    _ = (0, k.useRef)(e.initialMessages || []),
    v = (0, k.useRef)(!0);
  _.current = r;
  let y = (0, k.useRef)(e);
  y.current = e;
  let b = (0, k.useMemo)(() => {
    let t = v.current ? e.initialMessages || [] : _.current;
    return (
      (v.current = !1),
      new Ye({
        connection: y.current.connection,
        id: n,
        initialMessages: t,
        body: y.current.body,
        onResponse: (e) => y.current.onResponse?.(e),
        onChunk: (e) => y.current.onChunk?.(e),
        onFinish: (e) => {
          y.current.onFinish?.(e);
        },
        onError: (e) => {
          y.current.onError?.(e);
        },
        tools: y.current.tools,
        onCustomEvent: (e, t, n) => y.current.onCustomEvent?.(e, t, n),
  ...
  ((0, k.useEffect)(() => {
    b.updateOptions({ body: e.body });
  }, [b, e.body]),
    (0, k.useEffect)(() => {
      e.initialMessages &&
        e.initialMessages.length > 0 &&
        r.length === 0 &&
        b.setMessagesManually(e.initialMessages);
    }, []),
    (0, k.useEffect)(() => {
      e.live ? b.subscribe() : b.unsubscribe();
    }, [b, e.live]),
    (0, k.useEffect)(
      () => () => {
        e.live ? b.unsubscribe() : b.stop();
      },
      [b, e.live]
    ));
  ...
  return {
    ...
    connectionStatus: p,
    sessionGenerating: h,
    setMessages: (0, k.useCallback)(
      (e) => {
        b.setMessagesManually(e);
      },
      [b]
    ),
    clear: C,
    addToolResult: (0, k.useCallback)(
      async (e) => {
        await b.addToolResult(e);
      },
      [b]
    ),
    addToolApprovalResponse: (0, k.useCallback)(
      async (e) => {
        await b.addToolApprovalResponse(e);
      },
      [b]
    ),
  };
}
(new Uint8Array(128).fill(128), (0, k.createContext)(null));
function Qe({ content: e, className: t = ``, isComplete: n = !1 }) {
    ...
    (0, A.jsxs)(`div`, {
      ...
      children: [
        (0, A.jsxs)(`button`, {
          ...
          'aria-expanded': !r,
          'aria-label': r ? `Expand thinking` : `Collapse thinking`,
          children: [
            (0, A.jsx)(`span`, { className: `text-xs`, children: r ? `▶` : `▼` }),
            (0, A.jsx)(`span`, { className: `italic`, children: `💭 Thinking...` }),
            n && (0, A.jsx)(`span`, { className: `text-xs text-gray-500`, children: `(complete)` }),
          ],
        }),
        !r &&
          (0, A.jsx)(`div`, {
...
function $e({
  ...
  let l = [t, e.role === `user` ? n : r].filter(Boolean).join(` `);
  return (0, A.jsx)(`div`, {
    className: l || void 0,
...
function et({
  part: e,
  isThinkingComplete: t,
  textPartRenderer: n,
  thinkingPartRenderer: r,
  toolsRenderer: i,
  defaultToolRenderer: a,
  toolResultRenderer: o,
}) {
  if (e.type === `text`)
    return n
      ? (0, A.jsx)(A.Fragment, { children: n({ content: e.content }) })
      : (0, A.jsx)(`div`, {
          'data-part-type': `text`,
          'data-part-content': !0,
          children: e.content,
  ...
  if (e.type === `thinking`)
    return r
      ? (0, A.jsx)(A.Fragment, { children: r({ content: e.content, isComplete: t }) })
      : (0, A.jsx)(Qe, { content: e.content, isComplete: t });
  if (e.type === `tool-call`) {
    let t = {
      id: e.id,
      name: e.name,
    ...
    return i?.[e.name]
      ? (0, A.jsx)(A.Fragment, { children: i[e.name]?.(t) })
      : a
        ? (0, A.jsx)(A.Fragment, { children: a(t) })
        : (0, A.jsxs)(`div`, {
            ...
            children: [
              (0, A.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, A.jsx)(`span`, { 'data-tool-state-badge': !0, children: e.state }),
                ],
              }),
              e.arguments &&
                (0, A.jsx)(`div`, {
                  'data-tool-arguments': !0,
                  children: (0, A.jsx)(`pre`, { children: e.arguments }),
                }),
              e.approval &&
                (0, A.jsx)(`div`, {
                  'data-tool-approval': !0,
                  children:
                    e.approval.approved === void 0
                      ? `⏳ Awaiting approval...`
                      : e.approval.approved
                        ? `✓ Approved`
                        : `✗ Denied`,
              ...
              e.output &&
                (0, A.jsx)(`div`, {
                  'data-tool-output': !0,
                  children: (0, A.jsx)(`pre`, { children: JSON.stringify(e.output, null, 2) }),
                }),
            ],
          });
  }
  return e.type === `tool-result`
    ? o
      ? (0, A.jsx)(A.Fragment, {
          children: o({ toolCallId: e.toolCallId, content: e.content, state: e.state }),
        })
      : (0, A.jsx)(`div`, {
          'data-part-type': `tool-result`,
          'data-tool-call-id': e.toolCallId,
          'data-tool-result-state': e.state,
          children: (0, A.jsx)(`div`, { 'data-tool-result-content': !0, children: e.content }),
        })
    : null;
}
var I = l(),
  ...
  nt = (e, t) => tt(e, t, !0),
  rt = (0, k.createContext)(null);
function it() {
  return e((0, k.use)(rt), `useChatContext: ChatProvider is not provided`);
}
function at() {
  let e = (0, I.c)(22),
    { sendMessage: t, isLoading: n, messages: r, clear: i, stop: a } = it(),
    [o, s] = (0, k.useState)(``),
    c = (0, k.useRef)(null),
    l;
  e[0] !== n || e[1] !== t || e[2] !== o
  ...
  let _;
  return (
    e[18] !== m || e[19] !== h || e[20] !== g
      ? ((_ = (0, A.jsxs)(f, { children: [m, h, g] })),
        (e[18] = m),
        (e[19] = h),
        (e[20] = g),
        (e[21] = _))
...
function ot() {
  let e = (0, I.c)(7),
    { messages: t, error: n } = it(),
    r;
  e[0] === t ? (r = e[1]) : ((r = t.map(st)), (e[0] = t), (e[1] = r));
  let i;
  e[2] === n
    ? (i = e[3])
    : ((i =
...
` + n.stack,
  ...
  return (
    e[4] !== r || e[5] !== i
      ? ((a = (0, A.jsxs)(A.Fragment, { children: [r, i] })), (e[4] = r), (e[5] = i), (e[6] = a))
      : (a = e[6]),
    a
  );
}
function st(e) {
  return (0, A.jsx)(ct, { message: e }, e.id);
}
var ct = (e) => {
    let t = (0, I.c)(4),
      { message: n } = e,
    ...
    return (
      t[1] !== n || t[2] !== a
        ? ((o = (0, A.jsx)($e, { message: n, userClassName: i, textPartRenderer: a })),
          (t[1] = n),
          (t[2] = a),
          (t[3] = o))
        : (o = t[3]),
  ...
  lt = (e) => {
    ...
    return (
      t[0] === n
        ? (r = t[1])
        : ((r = (0, A.jsx)(A.Fragment, { children: n })), (t[0] = n), (t[1] = r)),
      r
    );
  },
  ut = (e) => {
    let n = (0, I.c)(4),
      { content: r } = e,
      i;
    n[0] === r ? (i = n[1]) : ((i = t.from({ md: r })), (n[0] = r), (n[1] = i));
    let a;
    return (
      n[2] === i
        ? (a = n[3])
        : ((a = (0, A.jsx)(le, { textScale: 0.95, value: i })), (n[2] = i), (n[3] = a)),
      a
    );
  },
  dt = w(``),
  ft = w(`closed`),
  pt = nt([dt, ft], (e, t) => ({ log: e, status: t }));
function mt() {
  return s(pt);
}
function ht() {
  (ft.set(`closed`), dt.set(``));
}
function gt() {
  let e = (0, I.c)(6),
    { log: t, status: n } = mt();
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, A.jsx)(_, { order: 4, children: `Semantic Layout` })), (e[0] = i))
    : (i = e[0]);
  let a = t || `Waiting for response...`,
    o;
  e[1] === a
    ? (o = e[2])
    : ((o = (0, A.jsx)(d, { whiteSpace: `pre-wrap`, children: a })), (e[1] = a), (e[2] = o));
  let s;
  return (
    e[3] !== r || e[4] !== o
      ? ((s = (0, A.jsx)(oe, {
...
var _t = T({
    ...
    children: be(D()).nullish().meta({ description: `Nested node IDs (if node is compound)` }),
    x: O(),
    y: O(),
    width: O(),
    height: O(),
  ...
  vt = M({
    ...
    needsApproval: !1,
    inputSchema: T({
      selectedNode: E().default(!1).meta({ description: `Include selected node (if any)` }),
      nodes: E().default(!1).meta({ description: `Include all nodes from the view` }),
    }),
    outputSchema: T({
      projectId: D(),
      editMode: E().meta({ description: `Whether the UI is in edit mode` }),
      view: T({
        id: D(),
        title: D(),
        type: ve([`element`, `deployment`, `dynamic`]).meta({
          description: `Type of the current view`,
        }),
      }).meta({ description: `Current view` }),
      nodes: be(_t).nullish(),
      selectedNode: _t.nullish(),
    }),
  }),
  yt = T({ type: ye(`focus`), elementId: D().meta({ description: `Element ID (FQN)` }) }).meta({
    description: `Focus UI on an element by its FQN`,
  }),
  bt = T({ type: ye(`fitview`) }).meta({
  ...
  xt = M({
    ...
    needsApproval: !1,
    inputSchema: T({ command: _e(`type`, [yt, bt]) }),
    outputSchema: T({}),
  }),
  St = M({
    name: `navigate_to`,
    ...
    needsApproval: !1,
    inputSchema: T({ viewId: D().meta({ description: `View ID` }) }),
    outputSchema: T({}),
  }),
  Ct = class {
    constructor() {
  ...
  wt = class {
    constructor(e) {
      ((this.generateIdentifier = e), (this.kv = new Ct()));
    }
    register(e, t) {
...
var kt = class {
    ...
    findApplicable(e) {
      return Dt(this.transfomers, (t) => t.isApplicable(e));
    }
    findByName(e) {
      return this.transfomers[e];
    }
  },
  At = b((e) => Object.prototype.toString.call(e).slice(8, -1), `getType`),
  jt = (e) => e === void 0,
  Mt = (e) => e === null,
  z = b(
    (e) =>
      typeof e != `object` || !e || e === Object.prototype
        ? !1
        : Object.getPrototypeOf(e) === null || Object.getPrototypeOf(e) === Object.prototype,
    `isPlainObject`
  ),
  B = (e) => z(e) && Object.keys(e).length === 0,
  V = b((e) => Array.isArray(e), `isArray`),
  Nt = (e) => typeof e == `string`,
  Pt = (e) => typeof e == `number` && !isNaN(e),
  Ft = (e) => typeof e == `boolean`,
  It = (e) => e instanceof RegExp,
  H = (e) => e instanceof Map,
  U = (e) => e instanceof Set,
  Lt = (e) => At(e) === `Symbol`,
  Rt = (e) => e instanceof Date && !isNaN(e.valueOf()),
  zt = (e) => e instanceof Error,
  Bt = (e) => typeof e == `number` && isNaN(e),
  Vt = (e) => Ft(e) || Mt(e) || jt(e) || Pt(e) || Nt(e) || Lt(e),
  Ht = (e) => typeof e == `bigint`,
  Ut = (e) => e === 1 / 0 || e === -1 / 0,
  Wt = (e) => ArrayBuffer.isView(e) && !(e instanceof DataView),
  Gt = (e) => e instanceof URL,
  W = (e) => e.replace(/\\/g, `\\\\`).replace(/\./g, `\\.`),
  G = (e) => e.map(String).map(W).join(`.`),
  K = (e, t) => {
    let n = [],
      r = ``;
...
var Kt = [
  ...
  q(
    (e) => Bt(e) || Ut(e),
    `number`,
    (e) => (Bt(e) ? `NaN` : e > 0 ? `Infinity` : `-Infinity`),
    Number
  ),
  q(
    (e) => e === 0 && 1 / e == -1 / 0,
...
var qt = J(
    (e, t) => (Lt(e) ? !!t.symbolRegistry.getIdentifier(e) : !1),
...
var Zt = J(
  ...
  $t = [Zt, qt, Qt, Yt],
  en = (e, t) => {
    let n = Ot($t, (n) => n.isApplicable(e, t));
    if (n) return { value: n.transform(e, t), type: n.annotation(e, t) };
    let r = Ot(Kt, (n) => n.isApplicable(e, t));
...
function rn(e) {
  if (R(e, `__proto__`)) throw Error(`__proto__ is not allowed as a property`);
  if (R(e, `prototype`)) throw Error(`prototype is not allowed as a property`);
  if (R(e, `constructor`)) throw Error(`constructor is not allowed as a property`);
}
var an = (e, t) => {
    rn(t);
  ...
  X = (e, t, n) => {
    ...
    let i = t[t.length - 1];
    if ((V(r) ? (r[+i] = n(r[+i])) : z(r) && (r[i] = n(r[i])), U(r))) {
      let e = Y(r, +i),
        t = n(e);
...
var ln = (e, t) => z(e) || V(e) || H(e) || U(e) || zt(e) || Xt(e, t);
function un(e, t, n) {
  let r = n.get(e);
...
function dn(e, t) {
  ...
  return (
    e.forEach((e) => {
      ...
      let [i, ...a] = e;
      i.length === 0 ? (r = a.map(G)) : (n[G(i)] = a.map(G));
    }),
    r ? (B(n) ? [r] : [r, n]) : B(n) ? void 0 : n
  );
}
var fn = (e, t, n, r, i = [], a = [], o = new Map()) => {
  let s = Vt(e);
  if (!s) {
    un(e, i, t);
    let n = o.get(e);
  ...
  if (!ln(e, n)) {
    let t = en(e, n),
      r = t ? { transformedValue: t.value, annotations: [t.type] } : { transformedValue: e };
    return (s || o.set(e, r), r);
  }
  if (R(a, e)) return { transformedValue: null };
  let c = en(e, n),
    l = c?.value ?? e,
    u = V(l) ? [] : {},
    d = {};
  L(l, (s, c) => {
    ...
    let l = fn(s, t, n, r, [...i, c], [...a, e], o);
    ((u[c] = l.transformedValue),
      V(l.annotations)
        ? (d[W(c)] = l.annotations)
        : z(l.annotations) &&
          L(l.annotations, (e, t) => {
  ...
  let f = B(d)
    ? { transformedValue: u, annotations: c ? [c.type] : void 0 }
    : { transformedValue: u, annotations: c ? [c.type, d] : d };
...
function Q(e, t = {}) {
  if (mn(e)) return e.map((e) => Q(e, t));
  if (!hn(e)) return e;
  let n = Object.getOwnPropertyNames(e),
    r = Object.getOwnPropertySymbols(e);
  return [...n, ...r].reduce((n, r) => {
    if (r === `__proto__` || (mn(t.props) && !t.props.includes(r))) return n;
    let i = e[r];
    return (gn(n, r, Q(i, t), e, t.nonenumerable), n);
  }, {});
}
var $ = class {
  constructor({ dedupe: e = !1 } = {}) {
    ((this.classRegistry = new Tt()),
      (this.symbolRegistry = new wt((e) => e.description ?? ``)),
      (this.customTransformerRegistry = new kt()),
      (this.allowedErrorProps = []),
      (this.dedupe = e));
  }
  serialize(e) {
    let t = new Map(),
      n = fn(e, t, this, this.dedupe),
      r = { json: n.transformedValue };
    n.annotations && (r.meta = { ...r.meta, values: n.annotations });
    let i = dn(t, this.dedupe);
    return (i && (r.meta = { ...r.meta, referentialEqualities: i }), r.meta && (r.meta.v = 1), r);
  }
  deserialize(e, t) {
    let { json: n, meta: r } = e,
      i = t?.inPlace ? n : Q(n);
    return (
      r?.values && (i = sn(i, r.values, r.v ?? 0, this)),
      r?.referentialEqualities && (i = cn(i, r.referentialEqualities, r.v ?? 0)),
      i
    );
  }
  stringify(e) {
...
(($.defaultInstance = new $()),
  ($.serialize = $.defaultInstance.serialize.bind($.defaultInstance)),
  ($.deserialize = $.defaultInstance.deserialize.bind($.defaultInstance)),
  ($.stringify = $.defaultInstance.stringify.bind($.defaultInstance)),
  ($.parse = $.defaultInstance.parse.bind($.defaultInstance)),
  ($.registerClass = $.defaultInstance.registerClass.bind($.defaultInstance)),
  ($.registerSymbol = $.defaultInstance.registerSymbol.bind($.defaultInstance)),
  ($.registerCustom = $.defaultInstance.registerCustom.bind($.defaultInstance)),
  ($.allowErrorProps = $.defaultInstance.allowErrorProps.bind($.defaultInstance)),
  $.serialize,
  $.deserialize);
var _n = $.stringify,
  vn = $.parse;
($.registerClass, $.registerCustom, $.registerSymbol, $.allowErrorProps);
function yn(e) {
  return ({ id: t, data: n, ...r }) => {
    let i = n.icon ?? void 0;
    i === `none` && (i = void 0);
    let a = e.parentLookup
      .get(t)
      ?.values()
      .map((e) => e.id)
      .toArray();
...
function bn() {
  ...
  if (e[0] !== r || e[1] !== n || e[2] !== t) {
    ...
    e[4] === n
      ...
      : ((o = (e) => {
          let { viewId: t } = e;
          return (n({ to: `./`, params: (e) => ({ ...e, viewId: t }) }), {});
        }),
        (e[4] = n),
        (e[5] = o));
    let s;
    e[6] !== r || e[7] !== t
      ? ((s = (e) => {
          let {
            ...
            l = s.enableReadOnly ?? c.enableReadOnly,
            u = yn(o.getState()),
            d = (e.nodes === !0 && he(a, u)) || void 0,
            f =
              e.selectedNode === !0 &&
              v(
                a,
                g((e) => !!e.selected || e.id === i),
                (e) => (e ? u(e) : void 0)
              );
          return {
            projectId: t,
            editMode: !l,
            view: { id: n.id, title: n.title ?? ``, type: n._type },
            ...(d && { nodes: d }),
            ...(f && { selectedNode: f }),
          };
        }),
    ...
    (e[9] === r
      ...
      : ((c = (e) => {
        ...
        (e[9] = r),
        (e[10] = c)),
      (i = Xe(St.client(o), vt.client(s), xt.client(c))),
      (e[0] = r),
      (e[1] = n),
      (e[2] = t),
      (e[3] = i));
...
var xn = {
  ...
  write(e) {
    try {
      ...
      sessionStorage.setItem(this.key, _n(e));
    } catch {}
  },
};
function Sn(e) {
  let t = (0, I.c)(7),
    n;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = { connection: Je(`/__likec4_ai`), initialMessages: xn.read() }), (t[0] = n))
    : (n = t[0]);
  let r = n,
    i = bn(),
    a;
  t[1] !== e || t[2] !== i
    ? ((a = { ...r, ...e, tools: i }), (t[1] = e), (t[2] = i), (t[3] = a))
    : (a = t[3]);
  let o = Ze(a),
    s,
    c;
...
function wn() {
  ...
  e.current ||= Cn.read() ?? { right: 16, bottom: 100 };
  let t = (t) => {
      e.current = Cn.write({ left: t.x, top: t.y });
    },
    [n, r] = x({ key: `likec4.ai.chat.collapsed`, defaultValue: !0 });
        ...
        children: [
          !n &&
            (0, A.jsx)(ae, {
              ...
              onPositionChange: t,
              children: (0, A.jsx)(Tn, { onClose: () => r(!0) }),
            }),
          n &&
            (0, A.jsx)(
              se.div,
              {
                ...
                exit: { translateX: `50%`, opacity: 0.1 },
                style: { position: `fixed`, right: 8, bottom: 60, zIndex: 1e3 },
                children: (0, A.jsx)(y, {
                  ...
                  children: (0, A.jsx)(ne, {
                    ...
                    variant: `gradient`,
                    onClick: () => r(!1),
                    children: (0, A.jsx)(pe, { stroke: 1.5 }),
                  }),
                }),
              },
              `collapsed`
...
function Tn(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, A.jsxs)(f, {
        children: [
          (0, A.jsx)(d, { textStyle: `likec4.panel`, noUserSelect: !0, children: `AI Assistant` }),
          (0, A.jsx)(te, { size: `xs`, radius: `sm`, variant: `light`, children: void 0 }),
        ],
      })),
      (t[3] = m))
    : (m = t[3]);
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = { content: u({ display: `contents` }) }), (t[6] = g))
    : (g = t[6]);
  let _;
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, A.jsx)(me, {
        ...
        children: (0, A.jsxs)(de, {
          children: [_, (0, A.jsx)(`div`, { ref: r, style: { height: 2 } })],
        }),
      })),
      (y = (0, A.jsx)(at, {})),
      (t[8] = v),
  ...
  t[10] === h
    ? (b = t[11])
    : ((b = (0, A.jsxs)(de, { w: `100%`, children: [h, v, y] })), (t[10] = h), (t[11] = b));
  let x;
  return (
    t[12] !== l || t[13] !== b
      ? ((x = (0, A.jsx)(rt, { value: l, children: b })), (t[12] = l), (t[13] = b), (t[14] = x))
      : (x = t[14]),
    x
  );
}
