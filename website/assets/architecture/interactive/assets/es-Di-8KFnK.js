...
function i(e) {
  let t = r(e, `border-left-width`),
    n = r(e, `border-right-width`);
  return e.clientWidth + t + n;
}
function a(e) {
  let t = r(e, `border-top-width`),
    n = r(e, `border-bottom-width`);
  return e.clientHeight + t + n;
}
function o(e, t = {}) {
  return { width: t.width || i(e), height: t.height || a(e) };
}
function s() {
  let e, t;
  try {
...
function l(e) {
  (e.width > c || e.height > c) &&
    (e.width > c && e.height > c
      ? e.width > e.height
        ? ((e.height *= c / e.width), (e.width = c))
        : ((e.width *= c / e.height), (e.height = c))
      : e.width > c
        ? ((e.height *= c / e.width), (e.width = c))
        : ((e.width *= c / e.height), (e.height = c)));
}
...
function h(e, t, n) {
  let r = `.${e}:${t}`,
    i = n.cssText ? ee(n) : te(n);
  return document.createTextNode(`${r}{${i}}`);
}
function g(e, n, r) {
  let i = window.getComputedStyle(e, r),
  ...
  (s.appendChild(h(o, r, i)), n.appendChild(s));
}
function _(e, t) {
  (g(e, t, `:before`), g(e, t, `:after`));
}
var v = `application/font-woff`,
  y = `image/jpeg`,
  ne = {
    woff: v,
    woff2: v,
...
async function E(e, t, n) {
  let r = ie(e, t, n.includeQueryParams);
  ...
  try {
    i = C(
      await w(
        e,
        n.fetchRequestInit,
        ({ res: e, result: n }) => ((t ||= e.headers.get(`Content-Type`) || ``), re(n))
      ),
      t
    );
  } catch (t) {
...
async function oe(e, t) {
  ...
  let n = e.poster;
  return d(await E(n, x(n), t));
}
async function se(e) {
  try {
    if (e?.contentDocument?.body) return await F(e.contentDocument.body, {}, !0);
  } catch {}
...
var O = (e) => e.tagName != null && e.tagName.toUpperCase() === `SLOT`;
async function k(e, t, r) {
  ...
  return (
    (i =
      O(e) && e.assignedNodes
        ? n(e.assignedNodes())
        : m(e, HTMLIFrameElement) && e.contentDocument?.body
          ? n(e.contentDocument.body.childNodes)
          : n((e.shadowRoot ?? e).childNodes)),
    i.length === 0 ||
      m(e, HTMLVideoElement) ||
      (await i.reduce(
        (e, n) =>
  ...
  i.cssText
    ...
    : n(i).forEach((n) => {
        ...
        (n === `font-size` &&
          ...
          m(e, HTMLIFrameElement) && n === `display` && a === `inline` && (a = `block`),
...
function N(e, t) {
  return (m(t, Element) && (A(e, t), _(e, t), j(e, t), M(e, t)), t);
}
...
function B(e) {
  let t = [];
  return (e.replace(I, (e, n, r) => (t.push(r), e)), t.filter((e) => !S(e)));
}
async function V(t, n, r, i, a) {
  try {
    let o = r ? e(n, r) : n,
      s = x(n),
      c;
    return ((c = a ? C(await a(o), s) : await E(o, s, i)), t.replace(z(n), `$1${c}$3`));
  } catch {}
  return t;
}
function H(e, { preferredFontFormat: t }) {
  return t
    ? e.replace(R, (e) => {
        for (;;) {
          let [n, , r] = L.exec(e) || [];
...
async function W(e, t, n) {
  if (!U(e)) return e;
  let r = H(e, n);
  return B(r).reduce((e, r) => e.then((e) => V(e, r, t, n)), Promise.resolve(r));
}
...
async function K(e, t) {
  ((await G(`background`, e, t)) || (await G(`background-image`, e, t)),
    (await G(`mask`, e, t)) || (await G(`mask-image`, e, t)));
}
async function ce(e, t) {
  let n = m(e, HTMLImageElement);
  if ((!n || S(e.src)) && (!m(e, SVGImageElement) || S(e.href.baseVal))) return;
...
async function q(e, t) {
  m(e, Element) && (await K(e, t), await ce(e, t), await le(e, t));
}
function ue(e, t) {
  let { style: n } = e;
...
async function Y(e) {
  let t = J[e];
  return t ?? ((t = { url: e, cssText: await (await fetch(e)).text() }), (J[e] = t), t);
}
  ...
  let n = e.cssText,
    ...
    i = (n.match(/url\([^)]+\)/g) || []).map(async (i) => {
      ...
      return (
        ...
        w(a, t.fetchRequestInit, ({ result: e }) => ((n = n.replace(i, `url(${e})`)), [i, e]))
      );
    });
          ...
          (r.href != null &&
            i.push(
              Y(r.href)
                ...
                .then((e) =>
                  Z(e).forEach((e) => {
                    a.insertRule(e, r.cssRules.length);
                  })
                )
                .catch((e) => {
...
function fe(e) {
  return e
    ...
    .filter((e) => U(e.style.getPropertyValue(`src`)));
}
async function pe(e, t) {
  if (e.ownerDocument == null) throw Error(`Provided element is not within a Document`);
  return fe(await de(n(e.ownerDocument.styleSheets), t));
}
...
async function Q(e, t) {
  let n = t.fontEmbedCSS == null ? (t.skipFonts ? null : await me(e, t)) : t.fontEmbedCSS;
  if (n) {
...
async function he(e, t = {}) {
  let { width: n, height: r } = o(e, t),
    i = await F(e, t, !0);
  return (await Q(i, t), await q(i, t), ue(i, t), await p(i, n, r));
}
async function $(e, t = {}) {
  let { width: n, height: r } = o(e, t),
    i = await d(await he(e, t)),
  ...
  return (
    ...
    (a.style.width = `${f}`),
    (a.style.height = `${p}`),
    t.backgroundColor && ((c.fillStyle = t.backgroundColor), c.fillRect(0, 0, a.width, a.height)),
...
async function _e(e, t = {}) {
  return await u(await $(e, t));
}
export { _e as toBlob, ge as toJpeg };
